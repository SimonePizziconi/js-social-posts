...
posts.forEach((element) => {
    ...
    const likeButton = document.querySelector(`a[data-postid="${element.id}"]`);;
    ...
    function(event){
        ...
        if(likeButton.classList.contains("like-button--liked")){
            // Rimuoviamo la classe per cambiare colore al testo del bottone
            likeButton.classList.remove("like-button--liked");

            // Decrentiamo il contatore dei "Mi Piace"
            element.likes--;
            ...
            // Aggiungiamo nell'array l'ID dei mi piace
